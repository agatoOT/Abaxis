...
WebUI.callTestCase(findTestCase('Web/BO VUE/LIB/Menu Selector'), [:], FailureHandling.STOP_ON_FAILURE)

'Queda pendiente de definición \r\n'
WebUI.callTestCase(findTestCase('Web/BO VUE/LIB/MenuBar'), [:], FailureHandling.STOP_ON_FAILURE)
