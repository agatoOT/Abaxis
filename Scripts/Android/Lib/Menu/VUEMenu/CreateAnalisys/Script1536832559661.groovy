...
Mobile.tap(findTestObject('Android/Create Analisys/android.widget.ImageView2'), 0)
...
Mobile.tap(findTestObject('Android/Create Analisys/android.widget.ImageButton0'), 0)
