...
WebUI.callTestCase(findTestCase('Android/Lib/Menu/ConfigurationMenu/FUSEConfig'), [:], FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('Android/Lib/Menu/VUEMenu/CreateAnalisys'), [:], FailureHandling.STOP_ON_FAILURE)
